...
const productSchema = new mongoose.Schema(
  {
    ...
    retailerPrice: { type: Number, default: 0, min: 0 },
    buyingPrice: { type: Number, default: 0, min: 0 },

    stockKg: { type: Number, default: 0 }, // KG part
    stockGm: { type: Number, default: 0 }, // Gram part
...
// Text search
productSchema.index({ name: "text", category: "text", code: "text" });
